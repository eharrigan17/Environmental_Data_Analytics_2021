...
# Plot the regression
irradiancebydepth <- 
  ggplot(PeterPaul.chem.nutrients, aes(x = depth, y = irradianceWater)) + ylim(0, 2000) +
  geom_point() 
...
```{r, fig.height = 3, fig.width = 4}
#filtering to see if there is a log linear relationship and remove outliner
...
# Add a line and standard error for the linear regression with log
irradiancebydepth2 <- 
...
```{r, fig.height = 3, fig.width = 4}
#correlation matrix to see the correlation between each variable
...
#Choose a model by AIC in a Stepwise Algorithm - help you choose which variables to remove. 
step(TPAIC)
