...
* size # size of point
* transparency #can make them transparent
...
PMplot <- 
  ...
  geom_point()
print(PMplot)
#^this plot wasn't telling us much so trying facets (the one below.) 
...
print(Nutrientplot6)
#^using the gathered dataset (pivot_wider/pivot_longer) would be a better dataset to use. 
