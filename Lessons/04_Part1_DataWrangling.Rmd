...
`>=`
`&`
#multiple conditions to check if true
`|`
...
#no rules for rows but can only filter between columns if same value

# dplyr filtering (put dataset first then what you want to filter)
