...
#data does not show normal distribution
...
# Post-hoc test that you can perform with anova tests
# TukeyHSD() computes Tukey Honest Significant Differences
TukeyHSD(Litter.Totals.anova)

# Extract groupings for pairwise relationships
#group=TRUE grouping together ones that have the same mean
...
#find treatment groups so equal TRUE
